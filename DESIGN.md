...
- **MIGI mascot provenance unconfirmed against the company knowledge base.** The MIGI giraffe-doctor art ships in the kit (from the brand team's asset drive), but the strings "MIGI"/"hươu"/"giraffe"/"linh vật" return zero matches in the Midu company knowledge base (`Z:\DU LIEU MIDU\MIDU BRAIN`). It is safe as a **decorative** mascot (it makes no health/product claim), but confirm with the brand team whether MIGI is an official, approved MIDU brand asset before treating it as canonical identity — this file currently presents it as established. The real, KB-confirmed brand facts (Công ty CP Midu MenaQ7, founded 2022, first in Vietnam to pioneer Vitamin K2/MenaQ7 from Natto Pharma, Norway; product line 45/180/360 mcg) are not in question; only the mascot's official status is.
